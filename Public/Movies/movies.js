      ...
      getMovieHistory()
        .then((result) => {
          ...
          pollList.forEach(poll => {
            ...
            listDiv.innerHTML += 
            '<button onclick="pollDetails(\'' + pollDate + '\')" class="w3-button w3-block w3-theme-l1 w3-left-align"><i class="fa fa-film fa-fw w3-margin-right"></i> '+ pollDate + '</button>' +
            ...
            innerDiv.innerHTML += '<h3 class="w3-center" style="font-size: 16px;">Winner: ' + poll.winner + ' - ' + poll.winNominator + '</h3>'
          });
        });
    } else {
